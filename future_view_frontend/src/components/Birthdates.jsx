...
const Birthdates = () => {
  ...
  const { selectedZodiacSignbirth1, updateSelectedZodiacSignbirth1 } = useAppContext();
  const { selectedZodiacSignbirth2, updateSelectedZodiacSignbirth2 } = useAppContext();
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `/soulmate-birthday?sign=${selectedZodiacSignbirth1},${selectedZodiacSignbirth2}`;
  };
  ...
  <div className="md:flex md:items-center md:justify-center md:w-full md:bg-gray-700">
    <div className="px-6 py-6 md:px-8 md:py-0">
      <h2 className="text-lg font-bold text-gray-700 dark:text-white md:text-gray-100">
        3. Find Your Soulmates' Birthdates
      </h2>
    </div>
  </div>
  ...
  <div className="flex items-center justify-center h-screen">
   ...
   <select
              ...
              name="zodiacSign"
              value={selectedZodiacSignbirth1}
              onChange={(e) => updateSelectedZodiacSignbirth1(e.target.value)}
            ...
            <select
              className="px-6 py-2 text-gray-700 placeholder-gray-500 bg-white outline-none dark:placeholder-gray-400 focus:placeholder-transparent dark:focus:placeholder-transparent"
              name="zodiacSign2"
              value={selectedZodiacSignbirth2}
              onChange={(e) => updateSelectedZodiacSignbirth2(e.target.value)}
              aria-label="Select your zodiac sign"
            >
              {/* Add an initial blank option */}
              <option value="" disabled hidden>
            ...
            <NavLink
              to={`/soulmate-birthday?sign=${selectedZodiacSignbirth1},${selectedZodiacSignbirth2}`}
              ...
              disabled={!selectedZodiacSignbirth1 || !selectedZodiacSignbirth2}
            >
              Get birthdates
            </NavLink>
          </div>
